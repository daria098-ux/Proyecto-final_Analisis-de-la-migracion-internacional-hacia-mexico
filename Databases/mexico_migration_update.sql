CREATE DATABASE mexico_migration2;
USE mexico_migration2;
...
-- NUEVO: último migration_id de un migrante (reemplaza el query directo)
...
select * from vw_impacts_on_mexico;
select * from vw_top_motives;
select * from vw_demographic_profile;